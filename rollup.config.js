...
const modernConfig = {
  input: {
    ['auro-datetime__bundled']: './src/auro-datetime.js',
  },
  output: {
    format: 'esm',
    dir: 'dist/'
...
const auroDatetimeConfig = {
  input: 'src/es5.js',
  output: {
    format: 'iife',
    file: 'dist/auro-datetime__bundled.es5.js'
  },
  plugins: getSharedPlugins(true)
};

export default [modernConfig, auroDatetimeConfig];
